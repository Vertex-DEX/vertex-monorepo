...
contract ExampleFlashSwap is IUniswapV2Callee {
    ...
    constructor(
        ...
        factory = _factory;
        WETH = IWETH(IVertexRouter01(router).WETH());
    }
    ...
    function uniswapV2Call(
        ...
        uint256 amountETH;
        {
            ...
            address token0 = IVertexPair(msg.sender).token0();
            address token1 = IVertexPair(msg.sender).token1();
            assert(msg.sender == VertexLibrary.pairFor(factory, token0, token1)); // ensure that msg.sender is actually a V2 pair
        ...
        if (amountToken > 0) {
            ...
            uint256 amountRequired = VertexLibrary.getAmountsIn(factory, amountToken, path)[0];
            ...
            uint256 amountRequired = VertexLibrary.getAmountsIn(factory, amountETH, path)[0];
